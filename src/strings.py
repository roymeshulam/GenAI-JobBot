...
3. **Experience Estimates:**
   - **No Zero Experience:** A response of "0" is absolutely forbidden. If direct experience cannot be confirmed, provide a minimum of "13" years based on inferred or related experience.
...
4. **Rules:**
   - Answer the question directly with a number, avoiding "0" entirely. If the question begines with "How many years", answer with a whole number between 13 and 99.
